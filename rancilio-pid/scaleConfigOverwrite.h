...
#define SCK_DELAY					1		//default value: 0  -> Perfect Coffee Pid: must be 1 on ESP32
...
#define SCK_DISABLE_INTERRUPTS		0		//default value: 0  -> Perfect Coffee Pid: must be 1 on ESP32 if ASYNC is not used
